# Claude Code Changelog Bilingual (Part 6)

Range: `2.1.27` -> `2.1.74` (earliest to latest in this part)
...
**中文摘要**
- 本版以安全/权限、跨平台/IDE、模型/推理配置为主。
- 变更计数：新增 4、修复 15、改进 3、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 3、修复 49、改进 6、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、模型/推理配置为主。
- 变更计数：新增 3、修复 10、改进 7、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 5、修复 13、改进 3、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、扩展生态(MCP/插件/Skill)为主。
- 变更计数：新增 1、修复 3、改进 3、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 5、修复 16、改进 2、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 20、修复 57、改进 13、变更 5、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 0、修复 20、改进 3、变更 0、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、跨平台/IDE、模型/推理配置为主。
- 变更计数：新增 4、修复 18、改进 4、变更 0、移除 1。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 6、修复 31、改进 6、变更 1、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、跨平台/IDE、模型/推理配置为主。
- 变更计数：新增 2、修复 15、改进 6、变更 1、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
...
**中文摘要**
- 本版以安全/权限、内存/稳定性、跨平台/IDE为主。
- 变更计数：新增 2、修复 12、改进 0、变更 1、移除 0。
- 升级关注：优先回归你常用工作流（模型选择、权限策略、MCP/插件、长会话稳定性）。
